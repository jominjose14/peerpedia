...
function Chat({ peerId, peerUsername }: ChatProps) {
    ...
    return (
        <section className="mt-8">
            ...
            <div ref={chatBox} className="h-110 overflow-y-auto border p-4 mt-4 space-y-2">
            ...
            <form onSubmit={onFormSubmit} className="mt-2">
                <input type="text" name="chat-message" id="chat-message" value={curMessage} onChange={e => setCurMessage(e.target.value)} placeholder="Type a message" className="w-full border px-4 py-2 outline-blue-500" />
